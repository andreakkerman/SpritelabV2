...
export function blankFrame(index=0){return{id:crypto.randomUUID(),name:`Frame ${index+1}`,durationMs:100,assetOverrides:{},repairOverrides:{},patches:[]}}
...
export function normalizeProject(project){project.frames||=[];for(const frame of project.frames){frame.assetOverrides||={};frame.repairOverrides||={};frame.patches||=[]}project.repairs||={};return project}
